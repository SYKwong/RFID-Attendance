...
//    tone(BUZZER1, 1975, 50); //B
//    delay(500);

    responseType = nano.readTagEPC(myEPC, myEPClength, 1000); //Scan for a new tag up to 750ms
//    Serial.println(F("Searching for tag"));

//    tone(BUZZER1, 988, 50); //B???
//    delay(500);
  }

  //Beep! Piano keys to frequencies: http://www.sengpielaudio.com/KeyboardAndFrequencies.gif
  //  tone(BUZZER1, 2093, 300); //C
  //  delay(300);
  //  tone(BUZZER1, 2349, 150); //D
  //  delay(150);
  tone(BUZZER1, 988, 150); //B??
  delay(150);
